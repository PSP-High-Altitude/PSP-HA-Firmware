...
static const uint16_t Model[] = {'P', 'A', 'L', ' ',
                                 '9', 'K', '4', 0}; /* last 2 bytes must be 0*/
...
static const uint16_t DevicePropDefVal[] = {
    'P', 'A', 'L', ' ', '9', 'K', '4', 0}; /* last 2 bytes must be 0*/
static const uint16_t DevicePropCurDefVal[] = {'P', 'A', 'L', ' ',
                                               '9', 'K', '4', 0};
