...
#define USBD_CMPSIT_ACTIVATE_MTP 1U
...
#if (USBD_CMPSIT_ACTIVATE_CDC == 1) || (USBD_CMPSIT_ACTIVATE_RNDIS == 1) || \
    (USBD_CMPSIT_ACTIVATE_CDC_ECM == 1)
typedef struct {
    /*
...
#endif /* (USBD_CMPSIT_ACTIVATE_CDC == 1) || (USBD_CMPSIT_ACTIVATE_RNDIS == 1) \
          || (USBD_CMPSIT_ACTIVATE_CDC_ECM == 1)*/
...
#define __USBD_CMPSIT_SET_IF(ifnum, alt, eps, class, subclass, protocol, \
                             istring)                                    \
    do {                                                                 \
