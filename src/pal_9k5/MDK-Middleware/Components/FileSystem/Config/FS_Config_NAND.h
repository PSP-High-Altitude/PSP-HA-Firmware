...
//   <i>Increase number of indexed blocks for better performance (default: 16
//   blocks).
...
//         <o>Layout <0=>Alternating Main and Spare <1=>Contiguous Main and
//         Spare <i>Alternating: |Main0|Spare0|...|MainN-1|SpareN-1|
