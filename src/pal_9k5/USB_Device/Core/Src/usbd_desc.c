...
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
#define USBD_VID                      0x4841//0x0483
#define USBD_PID                      0x5740
#define USBD_LANGID_STRING            0x0409
#define USBD_MANUFACTURER_STRING      "PSP High Altitude" /* Add your manufacturer string */
#define USBD_PRODUCT_HS_STRING        "PAL 9K4" /* Add your product High Speed string */
#define USBD_PRODUCT_FS_STRING        "PAL 9K4" /* Add your product Full Speed string */
#define USBD_CONFIGURATION_HS_STRING  "PAL 9K4 Config" /* Add your configuration High Speed string */
#define USBD_INTERFACE_HS_STRING      "PAL 9K4 Interface" /* Add your Interface High Speed string */
#define USBD_CONFIGURATION_FS_STRING  "PAL 9K4 Config" /* Add your configuration Full Speed string */
#define USBD_INTERFACE_FS_STRING      "PAL 9K4 Interface" /* Add your Interface Full Speed string */
