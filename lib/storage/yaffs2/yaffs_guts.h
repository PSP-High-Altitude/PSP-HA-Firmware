...
struct yaffs_tags_handler {
    ...
    int (*read_chunk_tags_fn)(struct yaffs_dev *dev, int nand_chunk, u8 *data,
...
int yaffs_update_oh(struct yaffs_obj *in, const YCHAR *name, int force,
                    int is_shrink, int shadows, struct yaffs_xattr_mod *xop);
...
#define FSIZE_COMBINE(high, low) \
    ((((loff_t)(high)) << 32) | (((loff_t)(low)) & 0xFFFFFFFF))
#endif
