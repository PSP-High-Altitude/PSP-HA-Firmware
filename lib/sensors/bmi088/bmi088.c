...
// Initialize
uint8_t current_acc_range;
uint8_t current_gyro_range;
double acc_conversion[] = {1.0 / 10920.0, 1.0 / 5460.0, 1.0 / 2730.0,
                           1 / 1365.0};
double gyro_conversion[] = {1.0 / 16.384, 1.0 / 32.768, 1.0 / 65.536,
...
Accel bmi088_acc_read(I2cDevice* device) {
    ...
    double cf = acc_conversion[current_acc_range];
...
Gyro bmi088_gyro_read(I2cDevice* device) {
    ...
    double cf = gyro_conversion[current_gyro_range];
